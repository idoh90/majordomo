...
import { initInstall } from './install/install'
...
export function bootApp() {
  ...
  try {
    ...
    // again — a listener hung inside a component would simply never hear it. It
    // lives on the APP's side of the boot gate on purpose: a stranger reading
    // the landing is not being asked to install anything.
    initInstall()
