...
export const majordomoPack: VoicePack = {
  ...
  grounds: {
    ...
    runNeedsDetail: 'Give it a distance first — a run with neither distance nor time records nothing.',
    ...
    exercises: {
      ...
      editTitle: 'Edit your exercise',
      editSave: 'Save changes',
      editHistoryNote:
        'Sessions already logged keep the name and muscles they were saved with. Only the picker changes.',
      editDelete: 'Delete',
      editDeleteTitle: 'Delete this exercise?',
      editDeleteBody: ({ name }) =>
        `“${name}” leaves the picker on every device. Sessions that used it are untouched.`,
      editDeleteConfirm: 'Delete',
      addSet: 'Add set',
  ...
  plan: {
    ...
    settingsLabel: 'Take on the full staff',
    settingsBlurb: 'You are on Basic. What Pro adds, what it costs, and what it never touches.',
    title: 'YOUR PLAN',
    close: 'Back to the app',
    eyebrow: 'TWO ARRANGEMENTS',
    headline: 'Run it yourself, or have it run.',
    intro: 'The Manor is yours either way, sir. What changes is how much of the rest is seen to.',
    cycleLabel: 'Billing',
    cycleMonthly: 'MONTHLY',
    cycleYearly: 'YEARLY',
    cycleSave: (pct) => `SAVE ${pct}%`,
    current: 'CURRENT',
    wingsLabel: 'WINGS',
    ...
    basic: {
      tag: 'BASIC',
      name: 'The Manor',
      tagline: "A gentleman's essentials, sir.",
      price: 'Free',
      priceNote: 'and stays that way',
      rosterNote: 'One wing, whichever you choose',
      presetNote: 'Midnight',
      points: [
        'The whole week: drag, drop, month view',
        'THE NIGHT, and the morning brief',
        'Offline always. Export any time.',
      ],
      cta: 'CARRY ON AS YOU ARE',
    },
    pro: {
      tag: 'PRO',
      name: 'Full Staff',
      tagline: 'The full staff, at your disposal.',
      perMonth: 'a month',
      perYear: 'a year',
      orYearly: (price) => `or ${price} a year, paid once`,
      yearlyNote: (perMonth) => `${perMonth} a month, paid once a year`,
      rosterNote: 'Every wing, all five at once',
      presetNote: 'Midnight, Terminal, Aurora',
      points: [
        'The what-if sandbox: rehearse a week before you commit to it',
        'Google Calendar, both ways',
        'Priority support: a person answers',
      ],
      cta: 'ENGAGE THE FULL STAFF',
      needsAccount: 'An account first. The staff need to know whose house it is.',
      reassurance: 'Cancel any time. Your records stay on your device, whatever you choose.',
      notOpen:
        "Payment isn't open yet. Nothing has been charged, and the house is exactly as you left it, sir.",
    },
    ...
    rows: [
      {
        label: 'The Manor',
        note: 'The whole week on one screen: drag, drop, resize, month view. The calendar is the product, and neither arrangement holds it back.',
        basic: true,
        pro: true,
      },
      {
        label: 'Wings',
        note: 'The Watch, the Grounds, the Study, the Workshop and the Ledger. Basic keeps one of them running, your choice. Pro keeps all five.',
        basic: 'One',
        pro: 'All five',
      },
      {
        label: 'THE NIGHT',
        note: 'Two clock times of a morning and everything that falls out of them: hours, debt, a body clock, and the recovery figure the Grounds reads.',
        basic: true,
        pro: true,
      },
      {
        label: 'The morning brief',
        note: 'One paragraph, each wing in its own colour, four instruments beneath it.',
        basic: true,
        pro: true,
      },
      {
        label: 'The what-if sandbox',
        note: 'Move the week around without committing to it. Apply the rehearsal or discard it; the record is untouched until you say.',
        basic: false,
        pro: true,
      },
      {
        label: 'Google Calendar',
        note: "Both ways. Your bookings appear in a calendar of their own, Google's own events hold their hours on the Manor, and Apple devices see it all through the same account.",
        basic: false,
        pro: true,
      },
      {
        label: 'Presets',
        note: 'Midnight, Terminal and Aurora. Three houses, one estate.',
        basic: 'Midnight',
        pro: 'All three',
      },
      {
        label: 'An account, every device',
        note: 'Sign in and your records follow you. Optional on either arrangement: the app never asks, and works in full without one.',
        basic: true,
        pro: true,
      },
      {
        label: 'Offline, and yours',
        note: 'The estate lives on your device and opens without a connection. Export the lot to a file whenever you like.',
        basic: true,
        pro: true,
      },
      {
        label: 'Priority support',
        note: 'A person, by email, ahead of the queue.',
        basic: false,
        pro: true,
      },
    ],
    faqTitle: 'ANTICIPATED QUESTIONS',
    faq: [
      {
        q: 'What happens to my records if I stop paying?',
        a: 'Nothing. They live on your device and always did. The staff stand down; the house stays exactly as it is.',
      },
      {
        q: 'Can I cancel?',
        a: 'Any time. The period you paid for runs its course, and nothing renews after it.',
      },
      {
        q: 'Do I need an account?',
        a: 'For Pro, yes: the staff need to know whose house it is. Basic never asks.',
      },
    ],
    footnote: 'Prices in US dollars. Local taxes may apply.',
  },
  onboarding: {
    welcome: {
      intro:
