...
export const majordomoPack: VoicePack = {
  ...
  workshop: {
    ...
    crew: {
      ...
      deleteButton: 'DELETE FOR EVERYONE',
      ...
      joinCta: 'JOIN',
      joining: 'Joining…',
      screenTitle: 'THE CREWS',
      screenBlurb:
        'Every venture you share, and every hand on it. Open one to a crew, decide who gets in, and say what each of them may do.',
      back: 'BACK',
      manageButton: 'THE CREWS',
      screenEmpty:
        'Nothing is shared yet, sir. Open a venture to a crew below, or join one with a code.',
      privacyTitle: 'THE DOOR',
      privacyOpen: 'OPEN',
      privacyVetted: 'BY APPROVAL',
      privacyOpenNote: 'Anyone holding the code joins at once.',
      privacyVettedNote: 'The code asks. You decide.',
      privacyStanding: ({ vetted }) =>
        vetted ? 'The keeper admits by hand.' : 'The code admits directly.',
      waitingTitle: 'AT THE DOOR',
      applicantLine: (label) => `${label} is waiting to be let in.`,
      admit: 'ADMIT',
      turnAway: 'TURN AWAY',
      turnAwayTitle: 'Turn them away?',
      turnAwayBody: (label) =>
        `${label} is not let in and sees nothing of the venture. They may knock again.`,
      turnAwayYes: 'Turn away',
      rankTitle: 'RANK',
      rank: { keeper: 'KEEPER', hand: 'HAND', guest: 'GUEST' },
      rankNote: {
        keeper: 'Keeps the crew — admits, ranks, disbands.',
        hand: 'Works the board, the milestones and the hours.',
        guest: 'Reads everything, changes nothing.',
      },
      ...
      toast: {
        ...
        applied:
          'The crew asks first, sir. Your application is with the keeper — you will be let in or you will not.',
        ...
        admitted: 'Admitted. The board is theirs as well now.',
        turnedAway: 'Turned away.',
        ranked: ({ label, rank }) => `${label} is a ${rank.toLowerCase()} from now on.`,
        doorOpen: 'The door is open — the code admits.',
        doorVetted: 'The door is vetted, sir. Nobody enters without your word.',
  ...
  onboarding: {
    ...
    install: {
      line: 'One last thing, sir. The house can sit on your home screen like any other app — full screen, no address bar, and it opens with no signal at all.',
      cta: 'SHOW ME HOW',
      skip: 'Not now',
    },
  },
  install: {
    desk: {
      ...
      line: 'The house is laid out for a desk, sir. The week, the pegboard and the body map all read better with the room to do it — everything works here, some of it works better there.',
      dismiss: 'UNDERSTOOD',
      guide: 'PUT IT ON MY HOME SCREEN',
    },
    title: 'THE HOME SCREEN',
    blurb:
      'Kept on the home screen, the house opens from its own icon: full screen, no address bar, and it works with nothing in the way — no signal, no aeroplane mode to argue with. It takes three taps.',
    already: 'Already on your home screen, sir. There is nothing to do.',
    oneTap: 'ADD IT NOW',
    oneTapNote: 'Your browser will ask you to confirm.',
    accepted: 'Done, sir. The icon is with your others.',
    refused: 'Your browser declined to ask, sir. The steps below still do it by hand.',
    steps: {
      ios: [
        'Press the share button at the foot of Safari — the square with an arrow leaving it.',
        'Scroll the list and choose “Add to Home Screen”.',
        'Press ADD. The icon lands beside everything else.',
      ],
      android: [
        'Press the three dots at the top right of Chrome.',
        'Choose “Install app”, or “Add to Home screen” where that is what it says.',
        'Confirm. The icon lands in your drawer and on the home screen.',
      ],
      desktop: [
        'Look at the right-hand end of the address bar for the install icon — a screen with an arrow.',
        'Press it, or open the browser menu and choose “Install Majordomo”.',
        'Confirm. The house gets a window of its own.',
      ],
    },
    close: 'CLOSE',
    settingsItem: 'Put Majordomo on the home screen',
    settingsBlurb: 'Opens from its own icon, full screen, and works with no signal.',
  },
  hints: {
